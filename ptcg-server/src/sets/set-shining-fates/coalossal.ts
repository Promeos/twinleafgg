...
import { PowerType, StoreLike, State, EnergyCard, GameError, GameMessage, PlayerType, AttachEnergyPrompt, SlotType, StateUtils } from '../../game';
...
export class Coalossal extends PokemonCard {
  ...
  public readonly TAR_GENERATOR_MARKER = 'COALOSSAL_SHF_TAR_GENERATOR_MARKER';

  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    // Ability: Tar Generator
    // Ref: set-rebel-clash/coalossal.ts (AttachEnergyPrompt with differentTypes=true, FIGHTING+FIRE, max 2)
