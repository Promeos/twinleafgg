...
export class Orbeetle extends PokemonCard {
  ...
  public readonly BUGS_RADAR_MARKER = 'ORBEETLE_SHF_BUGS_RADAR_MARKER';

  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    // Ability: Bug's Radar
    // Ref: set-sword-and-shield/orbeetle.ts (Bug's Radar - same ability, same card)
    ...
    // Attack 1: Brainwave
    // Ref: set-sword-and-shield/orbeetle.ts (Brainwave - CheckProvidedEnergyEffect for P energy count)
