...
export class GalarianObstagoon extends PokemonCard {
  ...
  public readonly OBSTRUCT_MARKER = 'GALARIAN_OBSTAGOON_SHF_OBSTRUCT_MARKER';
  public readonly CLEAR_OBSTRUCT_MARKER = 'GALARIAN_OBSTAGOON_SHF_CLEAR_OBSTRUCT_MARKER';
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    // Ref: set-vivid-voltage/galarian-obstagoon.ts (Untamed Shout)
    ...
    // Attack 1: Obstruct
    // Ref: set-vivid-voltage/galarian-obstagoon.ts (Obstruct - prevent damage from Basic Pokemon next turn)
