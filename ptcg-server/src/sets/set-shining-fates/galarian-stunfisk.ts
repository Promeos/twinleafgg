...
export class GalarianStunfisk extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    ...
    // Ref: set-sword-and-shield/galarian-stunfisk.ts (Snap Trap - same ability same card)
    ...
    // Ref: set-sword-and-shield/galarian-stunfisk.ts (Damage Rush - FLIP_A_COIN_UNTIL_YOU_GET_TAILS_DO_X_MORE_DAMAGE_PER_HEADS)
