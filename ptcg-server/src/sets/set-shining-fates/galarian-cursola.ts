...
export class GalarianCursola extends PokemonCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    // Ability: Perish Body (KO'd by opponent -> coin flip -> KO attacker)
    // Ref: set-rebel-clash/galarian-cursola.ts (Perish Body)
    ...
    // Attack 1: Corner
    // Ref: set-rebel-clash/galarian-cursola.ts (Corner - BLOCK_RETREAT pattern)
