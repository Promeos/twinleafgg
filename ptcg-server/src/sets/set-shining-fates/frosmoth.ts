...
export class Frosmoth extends PokemonCard {
  ...
  public powers = [{
    ...
    text: 'As often as you like during your turn, you may attach a [W] Energy card from your hand to 1 of your Benched Water Pokémon.'
  }];
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    // Ability: Ice Dance (attach Water energy from hand to benched Water Pokemon)
    // Ref: set-sword-and-shield/frosmoth.ts (Ice Dance - AttachEnergyPrompt with type check)
