...
export class Hatterene extends PokemonCard {
  ...
  public readonly MIND_HAT_MARKER = 'HATTERENE_SHF_MIND_HAT_MARKER';
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    // Ability: Mind Hat
    // Ref: set-rebel-clash/hatterene.ts (Mind Hat - same ability, same card)
    ...
    // Ref: set-rebel-clash/hatterene.ts (Dripping Grudge - same attack, same card)
